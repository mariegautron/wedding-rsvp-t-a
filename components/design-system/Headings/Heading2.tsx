...
const Heading2: React.FC<Heading2Props> = ({ children, color, className }) => {
  const headingClasses = cn(
    "text-5xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-8xl",
    "font-classico",
    "uppercase",
    "text-current",
    "text-center",
  ...
  return (
    <div className="relative flex flex-col items-center justify-center gap-4 group py-5 w-full md:overflow-visible overflow-hidden">
